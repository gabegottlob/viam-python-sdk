...
class Gripper(ComponentBase):
    ...
    async def get_kinematics(
        ...
        Returns:
            Tuple[KinematicsFileFormat.ValueType, bytes]: The kinematics of the component, in either URDF format or in Viam’s kinematic
            parameter format (spatial vector algebra) and the byte contents of the file.

        For more information, see `Kinematics <https://docs.viam.com/internals/kinematic-chain-config/#kinematic-parameters>`_.
        """
        ...
