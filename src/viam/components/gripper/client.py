...
from viam.utils import ValueTypes, dict_to_struct, get_geometries, get_kinematics, struct_to_dict
...
class GripperClient(Gripper, ReconfigurableResourceRPCClientBase):
    ...
    async def get_kinematics(
        ...
        **kwargs,
        ...
        md = kwargs.get("metadata", self.Metadata())
        return await get_kinematics(self.client, self.name, extra, timeout, md)